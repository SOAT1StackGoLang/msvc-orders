...
type ProductsService interface {
	...
	InsertProduct(ctx context.Context, userID uuid.UUID, product *models.Product) (*models.Product, error)
	UpdateProduct(ctx context.Context, userID uuid.UUID, product *models.Product) (*models.Product, error)
